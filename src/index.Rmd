...
A: Based off the plot, there is a positive correlation between ndmi and ndvi. I ran a correlation test and found that the correlation for summer months between NDMI and NDVI is 0.68. 
...
```
When we are considering all sites and time frames, the data shows that there is low correlation between snow cover and vegetation growth, 0.199. This low correlation between the previous year's snow cover on vegetation
growth for the following summer excludes several variables from burned to unburned, pre and post fire,and also doesnt account for differences in and runoff patterns between the sites since we don't know if there is a difference in elevation or slope that would impact the correlation between snow cover and vegetation growth. 
